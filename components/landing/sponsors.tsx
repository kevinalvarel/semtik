...
const platinumSponsors: Sponsor[] = [
  { name: 'Coming Soon', logoText: 'Coming Soon', color: 'hover:bg-[#5B8CFF]' },
  { name: 'Coming Soon', logoText: 'Coming Soon', color: 'hover:bg-[#55E6A5]' },
  { name: 'Coming Soon', logoText: 'Coming Soon', color: 'hover:bg-[#FFE44D]' },
];

const goldSponsors: Sponsor[] = [
  { name: 'Coming Soon', logoText: 'Coming Soon', color: 'hover:bg-[#FF6B9D]' },
  { name: 'Coming Soon', logoText: 'Coming Soon', color: 'hover:bg-[#FF8A3D]' },
  { name: 'Coming Soon', logoText: 'Coming Soon', color: 'hover:bg-[#5B8CFF]' },
  { name: 'Coming Soon', logoText: 'Coming Soon', color: 'hover:bg-[#55E6A5]' },
];
