...
import { Cpu, Shield, Terminal, Sparkles, Code2 } from "lucide-react";
    ...
    <>
      ...
      >
        ...
        <p className="text-sm font-bold text-black/80 leading-relaxed mb-6">
          ...
          Amankan tiketmu sekarang untuk belajar langsung dari praktisi industri
          global dan bangun dampak nyatamu di dunia teknologi!
        </p>
